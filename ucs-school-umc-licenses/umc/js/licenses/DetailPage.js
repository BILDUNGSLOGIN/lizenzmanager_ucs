...
define([
...
], function(declare, lang, domClass, Memory, Observable, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, entities, tools, dialog, Page, Grid, ContainerWidget, CheckBox, put, Cover, _) {

	const _Table = declare("umc.modules.licenses.Table", [_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
		//// overwrites
		templateString: `
			<div class="licensesTable">
				<div
					data-dojo-type="umc/modules/licenses/Cover"
					data-dojo-attach-point="_cover"
		...
		_setLicenseAttr: function(license) {
			this._cover.set('value', license.cover);
	...
	return declare("umc.modules.licenses.DetailPage", [ Page ], {
		//// overwrites
		fullWidth: true,
